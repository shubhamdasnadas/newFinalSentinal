 ...
 * Fetches ALL threats with pagination + 429 handling.
 *
 * Note: countOnly=true is removed because it returns only count, not full records.
 */
...
export async function GET(req: NextRequest) {
  try {
    ...
    do {
      const url = new URL(`${cleanBase}/web/api/v2.1/threats?countOnly=false`);
